...
export class NewTokenWallet extends EthereumEvent {
  get params(): NewTokenWallet__Params {
    return new NewTokenWallet__Params(this);
  }
}

export class NewTokenWallet__Params {
  _event: NewTokenWallet;

  constructor(event: NewTokenWallet) {
    this._event = event;
  }
...
export class KyberReserve extends SmartContract {
  ...
  tokenWallet(param0: Address): Address {
    let result = super.call("tokenWallet", [EthereumValue.fromAddress(param0)]);

    return result[0].toAddress();
  }

  try_tokenWallet(param0: Address): CallResult<Address> {
    let result = super.tryCall("tokenWallet", [
...
export class SetTokenWalletCall extends EthereumCall {
  get inputs(): SetTokenWalletCall__Inputs {
    return new SetTokenWalletCall__Inputs(this);
  }

  get outputs(): SetTokenWalletCall__Outputs {
    return new SetTokenWalletCall__Outputs(this);
  }
}

export class SetTokenWalletCall__Inputs {
  _call: SetTokenWalletCall;

  constructor(call: SetTokenWalletCall) {
    this._call = call;
  }
...
export class SetTokenWalletCall__Outputs {
  _call: SetTokenWalletCall;
