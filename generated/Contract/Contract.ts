...
export class Contract__getExpectedRateResult {
  value0: BigInt;
  value1: BigInt;
...
export class Contract extends SmartContract {
  ...
  getExpectedRate(
    ...
    dest: Address,
    srcQty: BigInt
  ): Contract__getExpectedRateResult {
    ...
    return new Contract__getExpectedRateResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getExpectedRate(
    ...
    dest: Address,
    srcQty: BigInt
  ): CallResult<Contract__getExpectedRateResult> {
    ...
    return CallResult.fromValue(
      new Contract__getExpectedRateResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
